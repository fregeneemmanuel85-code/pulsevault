      ...
      <div className="p-4 md:p-8">
        ...
        <div className="grid gap-4">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="h-24 md:h-20 bg-gray-100 rounded-xl animate-pulse"
            />
          ))}
        </div>
      </div>
  ...
  return (
    <div className="p-4 md:p-6 max-w-6xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-xl border overflow-hidden">
        {/* Desktop Header */}
        <div className="hidden md:grid md:grid-cols-12 md:gap-4 p-4 border-b bg-gray-50 text-sm font-medium text-gray-500">
            ...
            <div key={site.id} className="border-b last:border-b-0">
              ...
              {isExpanded &&
                (!site.seoIssues || site.seoIssues.length === 0) && (
                  <div className="px-4 pb-4 bg-gray-50/50">
                    <div className="md:ml-6 p-3 text-sm text-gray-500 flex items-center gap-2">
